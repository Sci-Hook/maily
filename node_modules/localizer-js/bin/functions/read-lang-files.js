...
exports.read_lang_files = void 0;
var json_parse_1 = require("../utils/json-parse");
require("syncforeachloop");
function read_lang_files(config) {
    var langs = Object.assign([], config['langs']);
    if (config.global) {
        langs.push('global');
    }
    var input_dir = config['input-dir'];
    var file_names = Object.keys(config['files']);
    var result = {};
                                ...
                                if (lang == 'global') {
                                    langs.forEach(function (lang) {
                                        ...
                                        if (!result[lang][name])
                                            return;
                                        if (lang != 'global') {
                                            result[lang][name] = Object.assign(result[lang][name], data);
                                        }
                                    });
                                }
                                else {
...
exports.read_lang_files = read_lang_files;
